 ...
 * @property {'New' | 'Contacted' | 'Proposal' | 'Won' | 'Lost'} status - Pipeline stage status.
...
const PipelineOverview = ({ leads = [] }) => {
  ...
  const STATUS_CONFIG = {
    ...
    Proposal: { label: 'Proposal', colorClass: 'bg-indigo-500', textClass: 'text-indigo-600', badgeClass: 'bg-indigo-50 text-indigo-600 border-indigo-100' },
