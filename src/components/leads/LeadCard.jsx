...
const LeadCard = ({ lead, onEdit, onDelete }) => {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-800 p-5 shadow-xs dark:shadow-none hover:shadow-md transition-all duration-300 transform hover:-translate-y-0.5 flex flex-col justify-between h-full group">
      <div>
        ...
        <div className="flex items-start justify-between gap-2 mb-3">
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">{lead.company}</p>
          </div>
        ...
        <div className="space-y-2 mt-4 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="flex items-center gap-2">
            ...
            {lead.phone ? (
              ...
              <span className="text-gray-400 dark:text-gray-500 italic">No phone provided</span>
            )}
          </div>

          {lead.source && (
            <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-900 px-2.5 py-1 rounded-lg w-fit mt-1 border border-gray-100 dark:border-gray-800">
      ...
      <div className="flex items-center justify-between border-t border-gray-100 dark:border-gray-800 mt-5 pt-4">
        {lead.value !== undefined && lead.value > 0 ? (
          ...
          <span className="text-xs text-gray-400 dark:text-gray-500 italic">No value</span>
        )}
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={() => onEdit(lead)}
            className="p-2 text-gray-500 dark:text-gray-400 hover:text-primary hover:bg-primary/5 rounded-xl border border-transparent hover:border-primary/10 transition-all cursor-pointer"
          ...
          <button
            ...
            className="p-2 text-gray-500 dark:text-gray-400 hover:text-danger hover:bg-danger/5 rounded-xl border border-transparent hover:border-danger/10 transition-all cursor-pointer"
