                ...
                <tr key={lead.id} className="hover:bg-gray-50/50 transition-colors duration-150 group">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        onClick={() => onEdit(lead)}
                        className="p-1.5 text-gray-500 hover:text-primary hover:bg-primary/5 rounded-lg border border-transparent hover:border-primary/10 transition-all cursor-pointer"
                      ...
                      <button
                        ...
                        className="p-1.5 text-gray-500 hover:text-danger hover:bg-danger/5 rounded-lg border border-transparent hover:border-danger/10 transition-all cursor-pointer"
